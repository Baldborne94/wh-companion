...
// ─── FULL READING ORDER ───────────────────────────────────────────────────────
// Ordine cronologico completo, costruito sull'intero catalogo AOS_BOOKS (vedi Overview).
export const AOS_FULL = [
  {
    id:"af1", label:"Parte 1", title:"The Realmgate Wars",
    note:"Edizione 1ª. Gli Stormcast Eternals, guerrieri forgiati dalla folgore di Sigmar, discendono sui Reami Mortali per strapparli alle grinfie del Caos.",
    books:[
      { t:"The Gates of Azyr",         a:"Chris Wraight",                       aos_id:"aos1",  type:"novella" },
      ...
      { t:"Wardens of the Everqueen",  a:"C L Werner",                          aos_id:"aos5",  type:"novella",   opt:true },
      { t:"Call of Archaon",           a:"David Annandale, Guy Haley, Rob Sanders", aos_id:"aos6", type:"anthology", opt:true },
      { t:"Warbeast",                  a:"Gav Thorpe",                          aos_id:"aos7",  type:"novella",   opt:true },
      { t:"Fury of Gork",              a:"Josh Reynolds",                       aos_id:"aos8",  type:"novella",   opt:true },
      { t:"Bladestorm",                a:"Matt Westbrook",                      aos_id:"aos9",  type:"novella",   opt:true },
      { t:"Mortarch of Night",         a:"Josh Reynolds",                       aos_id:"aos10", type:"novella",   opt:true },
      { t:"Lord of Undeath",           a:"C L Werner",                          aos_id:"aos11", type:"novella",   opt:true },
    ],
  },
  {
    id:"af2", label:"Parte 2", title:"Soul Wars & the Necroquake",
    note:"Edizione 2ª. Il Grande Rituale di Nagash devasta i Reami con la Necroquake. L'era delle Soul Wars ridisegna ogni fazione e ogni alleanza.",
    books:[
      { t:"Nagash: The Undying King",        a:"Josh Reynolds",   aos_id:"aos41" },
      { t:"Soul Wars",                        a:"Josh Reynolds",   aos_id:"aos42" },
      { t:"Hallowed Knights: Plague Garden",  a:"Josh Reynolds",   aos_id:"aos14" },
      ...
      { t:"Neferata: The Dominion of Bones",  a:"David Annandale", aos_id:"aos44", opt:true },
  ...
  },
  {
    ...
    note:"I Reami si espandono. Cacciatori di reliquie, avventurieri e forze del Caos si scontrano su ogni fronte, dalle Città Libere alle terre dei morti.",
    books:[
      ...
      { t:"Realm-Lords",                           a:"Dale Lucas",      aos_id:"aos46", opt:true },
      { t:"Lady of Sorrows",                       a:"C L Werner",      aos_id:"aos47", opt:true },
      { t:"Stormvault",                            a:"Andy Clark",      aos_id:"aos48", opt:true },
      { t:"Bonereapers",                           a:"David Guymer",    aos_id:"aos49", type:"novella", opt:true },
      { t:"Cursed City",                           a:"C L Werner",      aos_id:"aos52", opt:true },
      { t:"The Hollow King",                       a:"John French",     aos_id:"aos53", opt:true },
      { t:"The Red Feast",                         a:"Gav Thorpe",      aos_id:"aos69", opt:true },
    ],
  },
  {
    id:"af4", label:"Parte 4", title:"Broken Realms",
    note:"Le campagne narrative che hanno cambiato le sorti di ogni Grande Fazione — Morathi, Teclis, Be'lakor, Kragnos.",
    books:[
  ...
  },
  {
    ...
    note:"Edizione 3ª. Kragnos è libero, Archaon è indebolito — i Dawnbringers marciano per recuperare i Reami caduti.",
    books:[
      { t:"Dominion",                        a:"Darius Hinks",     aos_id:"aos51" },
      ...
      { t:"The Last Volari",                 a:"Gary Kloster",     aos_id:"aos73", opt:true },
      { t:"Harrowed Ground",                 a:"Richard Strachan", aos_id:"aos54", opt:true },
      { t:"Starseer's Ruin",                 a:"Adrian Tchaikovsky", aos_id:"aos56", opt:true },
    ],
  },
  {
