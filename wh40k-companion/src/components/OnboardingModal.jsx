...
const SLIDES = [
  ...
  },
  {
    ...
    bullets: [
      "YouTube playlists: WH40K & AoS battle ambiences",
      "Spotify integration for your own playlists",
      "Mini player stays visible while you browse or read",
      "Music never stops — even when you switch sections",
    ],
  },
  {
    accent: "#c9a84c",
    ...
    bullets: [
      ...
      "Per-unit notes & colour tracking",
