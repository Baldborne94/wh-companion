...
// âââ READER THEMES âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const THEMES = {
...
// âââ READER FONTS ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const FONTS = [
...
// âââ APP COLOURS âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const C = {
...
// âââ LORE DATABASE ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const LORE_DB = {
  "horus":{ name:"Horus Lupercal",type:"character",subtitle:"Warmaster â¢ Primarch of the Luna Wolves",icon:"ð",safe:"The favoured son of the Emperor and supreme Warmaster of the Imperium. Horus led the Great Crusade and was revered above all other Primarchs â a warrior of unmatched skill, charisma and tactical genius.",spoiler:"Mortally wounded at the Serpent Lodge on Davin, Horus was healed through Chaos corruption. He turned against the Emperor and ignited the Horus Heresy. He died during the Siege of Terra, slain by the Emperor himself.",spoilerFrom:"False Gods (Horus Heresy #2)" },
  "luna wolves":{ name:"Luna Wolves / Sons of Horus",type:"faction",subtitle:"XVI Legion",icon:"ðº",safe:"The XVI Space Marine Legion, personally commanded by Primarch Horus. Renowned throughout the Great Crusade as unstoppable shock troops.",spoiler:"After Horus's corruption the Legion was renamed the Sons of Horus, becoming vanguard of the traitor forces.",spoilerFrom:"False Gods (HH #2)" },
  "emperor":{ name:"The Emperor of Mankind",type:"character",subtitle:"The Master of Mankind",icon:"â",safe:"The immortal ruler of humanity, founder of the Imperium and creator of the Primarchs. The most powerful psyker in human history.",spoiler:"Mortally wounded by Horus at the Siege of Terra, the Emperor was interred within the Golden Throne â existing in a state of living death.",spoilerFrom:"The End and the Death (Siege of Terra)" },
  "primarch":{ name:"Primarchs",type:"concept",subtitle:"The Emperor's Demigod Sons",icon:"ð§¬",safe:"Twenty demigod warriors created by the Emperor from his own genetic material. Each was superhuman in power, intellect and force of personality â gene-fathers of the Space Marine Legions.",spoiler:"Nine sided with Horus (Traitor Legions), nine remained loyal. The conflict shattered the original Legion structure forever.",spoilerFrom:"Various (Horus Heresy series)" },
  "space marines":{ name:"Space Marines",type:"faction",subtitle:"Adeptus Astartes",icon:"â¬¡",safe:"Genetically enhanced superhuman warriors created from the Emperor's genetic blueprint. Each receives 19 gene-seed implants that transform them into towering warriors of superhuman ability.",spoiler:null,spoilerFrom:null },
  "chaos":{ name:"Chaos",type:"concept",subtitle:"The Ruinous Powers",icon:"â§",safe:"The collective name for the malevolent energies of the Warp. Four major gods: Khorne (war), Tzeentch (change), Nurgle (decay), Slaanesh (excess). Chaos tempts, corrupts and destroys.",spoiler:null,spoilerFrom:null },
  "warp":{ name:"The Warp",type:"concept",subtitle:"The Immaterium",icon:"ð",safe:"A parallel dimension of pure psychic energy. Source of all psychic power and medium for faster-than-light travel. Also home to daemons, Chaos Gods and malevolent entities that prey on mortal souls.",spoiler:null,spoilerFrom:null },
  "isstvan iii":{ name:"Isstvan III",type:"battle",subtitle:"The First Betrayal",icon:"â ",safe:"A planetary bombardment ordered by Horus. Loyalist Space Marines from the traitor legions were deployed to the surface, then bombarded with lethal virus bombs â killed by their own commanders.",spoiler:"Survivors led by Captain Garro fought back against the traitors. This event marked the first open act of the Heresy.",spoilerFrom:"Galaxy in Flames (HH #3)" },
  "isstvan v":{ name:"Isstvan V",type:"battle",subtitle:"The Drop Site Massacre",icon:"ð",safe:"A world in the Isstvan system where Horus's rebellion first became open war.",spoiler:"Three loyalist Legions were deployed to crush the traitors, only to be betrayed when four more supposedly loyal Legions turned their guns on them. Tens of thousands of Space Marines were killed.",spoilerFrom:"Fulgrim (HH #5)" },
  "great crusade":{ name:"The Great Crusade",type:"event",subtitle:"~800-005.M31",icon:"âï¸",safe:"The Emperor's grand campaign to reunite all of humanity under a single Imperium, conducted over two centuries. Led by the Primarchs and their Legions.",spoiler:null,spoilerFrom:null },
  "death guard":{ name:"Death Guard",type:"faction",subtitle:"XIV Legion",icon:"â£",safe:"The XIV Space Marine Legion, led by Primarch Mortarion. Known for their legendary endurance. Specialists in grinding, implacable warfare and siege combat.",spoiler:"During the Heresy the fleet became becalmed in the Warp. Nurgle offered salvation from a plague killing the entire fleet. Mortarion accepted â transforming the Legion into Plague Marines.",spoilerFrom:"The Buried Dagger (HH #54)" },
  "thousand sons":{ name:"Thousand Sons",type:"faction",subtitle:"XV Legion",icon:"ð®",safe:"The XV Space Marine Legion led by Magnus the Red. A Legion of prodigious psychic talent â virtually every warrior was a psyker. They pursued knowledge and sorcery with obsessive dedication.",spoiler:"Magnus made a catastrophic mistake using forbidden sorcery. As punishment the Space Wolves were sent to destroy Prospero. The Thousand Sons eventually fell to Tzeentch.",spoilerFrom:"A Thousand Sons (HH #12)" },
  "word bearers":{ name:"Word Bearers",type:"faction",subtitle:"XVII Legion",icon:"ð",safe:"The XVII Legion led by Lorgar Aurelian. The most devout of all the Legions â fervent missionaries who spread the Emperor's creed. They constructed vast temples demanding worship.",spoiler:"The Emperor publicly humiliated Lorgar for his religious devotion. This broke Lorgar, who found true gods in Chaos. The Word Bearers became the first Legion to turn traitor.",spoilerFrom:"The First Heretic (HH #14)" },
  "night lords":{ name:"Night Lords",type:"faction",subtitle:"VIII Legion",icon:"ð¦",safe:"The VIII Legion led by Konrad Curze. Masters of terror and psychological warfare. They operated in darkness, spreading fear through brutal theatrical violence.",spoiler:null,spoilerFrom:null },
  "alpha legion":{ name:"Alpha Legion",type:"faction",subtitle:"XX Legion",icon:"ð",safe:"The XX Legion â most secretive of all, masters of infiltration and subversion. Led by twin Primarchs Alpharius and Omegon. Their motto: 'I am Alpharius.'",spoiler:null,spoilerFrom:null },
  "inquisition":{ name:"The Inquisition",type:"faction",subtitle:"Ordo Malleus â¢ Ordo Xenos â¢ Ordo Hereticus",icon:"ð",safe:"The secret organisation protecting the Imperium from threats within and without. Inquisitors wield near-unlimited authority, investigating heresy, daemon incursion and alien infiltration.",spoiler:null,spoilerFrom:null },
  "sanguinius":{ name:"Sanguinius",type:"character",subtitle:"Primarch of the Blood Angels",icon:"ð©¸",safe:"Primarch of the Blood Angels. Possessed of angelic wings and impossible beauty, considered by many to be the greatest of all the Primarchs. A warrior-poet of extraordinary compassion.",spoiler:"Sanguinius was slain by Horus at the Siege of Terra. His death created the Sanguinary curse â the Black Rage â that afflicts Blood Angels to this day.",spoilerFrom:"Fear to Tread (HH #21)" },
  "prospero":{ name:"Prospero",type:"battle",subtitle:"The Burning of Prospero",icon:"ð¥",safe:"Homeworld of the Thousand Sons. A world of crystal cities and vast libraries of forbidden lore.",spoiler:"The Emperor dispatched the Space Wolves to destroy Prospero as punishment for Magnus's forbidden sorcery. Prospero burned, and Magnus made a pact with Tzeentch.",spoilerFrom:"A Thousand Sons (#12) / Prospero Burns (#15)" },
  "aeldari":{ name:"Aeldari (Eldar)",type:"faction",subtitle:"The Elder Race",icon:"â",safe:"An ancient race whose Fall shattered their empire and birthed the Chaos God Slaanesh. Now a dying race, surviving Aeldari live aboard vast Craftworld ships.",spoiler:null,spoilerFrom:null },
  "necrons":{ name:"Necrons",type:"faction",subtitle:"The Undying Legions",icon:"â½",safe:"An ancient race of living metal warriors who slumbered for sixty million years. Once flesh-and-blood, the Necrontyr transferred their consciousnesses into indestructible metal bodies.",spoiler:null,spoilerFrom:null },
  "eisenhorn":{ name:"Gregor Eisenhorn",type:"character",subtitle:"Inquisitor â¢ Ordo Xenos",icon:"ð",safe:"One of the most renowned Inquisitors of his age. A skilled investigator, powerful psyker and relentless hunter of heresy and alien conspiracy.",spoiler:"Over decades Eisenhorn increasingly uses radical methods including daemonhosts. His colleagues brand him a radical and eventually a heretic.",spoilerFrom:"Malleus (Eisenhorn #2)" },
  "gaunt":{ name:"Ibram Gaunt",type:"character",subtitle:"Colonel-Commissar â¢ Tanith First",icon:"ð",safe:"Colonel-Commissar of the Tanith First-and-Only. A rare combination of field commander and political officer who earned fierce loyalty through competence and genuine care.",spoiler:null,spoilerFrom:null },
  "tanith":{ name:"Tanith First-and-Only",type:"faction",subtitle:"Gaunt's Ghosts",icon:"ð",safe:"An Imperial Guard regiment from the destroyed world of Tanith. Unparalleled scouts and light infantry using stealth skills and camo-cloaks. They serve in the brutal Sabbat Worlds Crusade.",spoiler:null,spoilerFrom:null },
};
...
// âââ EPUB PARSER ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// âââ DICTIONARY PANEL âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return(
    <div onClick={onClose} style={{position:"fixed",inset:0,zIndex:900,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"flex-end",justifyContent:"center"}}>
      <div onClick={e=>e.stopPropagation()} style={{background:T.surface,border:`1px solid ${T.border}`,borderTop:`2px solid ${C.gold}`,borderRadius:"16px 16px 0 0",padding:"20px 20px 48px",width:"100%",maxWidth:600,maxHeight:"60vh",overflowY:"auto",animation:"slideUp 0.2s ease"}}>
        ...
        {loading&&<div style={{textAlign:"center",padding:24,color:T.muted,fontStyle:"italic"}}>Looking up "{word}"â¦</div>}
...
// âââ LORE PANEL âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
    ...
    <div onClick={onClose} style={{position:"fixed",inset:0,zIndex:900,background:"rgba(0,0,0,0.7)",display:"flex",alignItems:"flex-end",justifyContent:"center"}}>
      <div onClick={e=>e.stopPropagation()} style={{background:T.surface,border:`1px solid ${C.gold}55`,borderTop:`2px solid ${C.gold}`,borderRadius:"16px 16px 0 0",padding:"20px 20px 48px",width:"100%",maxWidth:600,maxHeight:"75vh",overflowY:"auto",animation:"slideUp 0.25s ease"}}>
        ...
        <div style={{marginBottom:16}}>
          <div style={{fontFamily:"'Cinzel',serif",fontSize:9,color:C.goldDim,letterSpacing:3,textTransform:"uppercase",marginBottom:8}}>â Safe Info</div>
          ...
          <div style={{background:T.bg==="paper"?"#fff8f8":"#ffffff05",border:`1px solid ${showSpoiler?"#cc3333":"#cc333444"}`,borderRadius:10,padding:"14px 16px"}}>
            {!showSpoiler?(
              <>
                ...
                <button onClick={()=>setShowSpoiler(true)} style={{width:"100%",padding:"10px",borderRadius:8,background:"transparent",border:`1px solid ${C.red}88`,color:C.red,fontFamily:"'Cinzel',serif",fontSize:11,letterSpacing:2,textTransform:"uppercase",cursor:"pointer"}}>I accept spoilers â Show full info</button>
              </>
            ):(
              <>
                <div style={{fontFamily:"'Cinzel',serif",fontSize:9,color:"#cc3333",letterSpacing:3,textTransform:"uppercase",marginBottom:8}}>â ï¸ Spoiler â {entry.spoilerFrom}</div>
    ...
    <div onClick={onClose} style={{position:"fixed",inset:0,zIndex:800,background:"rgba(0,0,0,0.5)"}}>
      <div onClick={e=>e.stopPropagation()} style={{position:"absolute",right:0,top:0,bottom:0,width:Math.min(320,window.innerWidth),background:T.surface,borderLeft:`1px solid ${T.border}`,padding:"20px 20px 40px",overflowY:"auto",animation:"slideLeft 0.25s ease"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}>
          ...
          <button onClick={onClose} style={{background:"transparent",border:`1px solid ${T.border}`,borderRadius:6,color:T.muted,width:32,height:32,cursor:"pointer",fontSize:16}}>â</button>
        </div>
        ...
        {/* Font size */}
        <Row label={`Size â ${settings.fontSize}px`}>
        ...
        {/* Line height */}
        <Row label={`Line height â ${settings.lineHeight}Ã`}>
          <div style={{display:"flex",gap:6}}>
...
// âââ EPUB READER ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
function EpubReader({ url, title, bookId, initProgress, onProgress, onClose }) {
  ...
  if(loading) return(
    <div style={{position:"fixed",inset:0,zIndex:600,background:THEMES.dark.bg,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:20}}>
      <div style={{fontSize:52,animation:"spin 2s linear infinite"}}>â</div>
      <div style={{fontFamily:"'Cinzel',serif",fontSize:13,color:C.goldDim,letterSpacing:3}}>Decrypting tomeâ¦</div>
  ...
  return(
    <div style={{position:"fixed",inset:0,zIndex:600,background:T.bg,display:"flex",flexDirection:"column",transition:"background 0.3s"}}>
      ...
      <div style={{flexShrink:0,height:52,background:T.ui,borderBottom:`1px solid ${T.border}`,display:"flex",alignItems:"center",padding:"0 12px",gap:8,transition:"opacity 0.3s, transform 0.3s",opacity:showUI?1:0,transform:showUI?"translateY(0)":"translateY(-100%)",pointerEvents:showUI?"auto":"none",position:"relative",zIndex:2}}>
        <button onClick={onClose} style={{background:"transparent",border:`1px solid ${T.border}`,borderRadius:8,color:T.text,padding:"7px 14px",cursor:"pointer",fontFamily:"'Cinzel',serif",fontSize:12,letterSpacing:1,flexShrink:0}}>â Back</button>
        ...
        <button onClick={()=>{setShowToc(t=>!t);setShowUI(true);}} style={{background:showToc?`${C.gold}22`:"transparent",border:`1px solid ${showToc?C.gold:T.border}`,borderRadius:6,color:showToc?C.gold:T.muted,width:34,height:34,cursor:"pointer",fontSize:16}}>â¡</button>
        <button onClick={()=>{setShowSettings(true);setShowUI(true);}} style={{background:"transparent",border:`1px solid ${T.border}`,borderRadius:6,color:T.muted,width:34,height:34,cursor:"pointer",fontSize:16}}>â</button>
      </div>
      ...
      <div style={{flexShrink:0,background:T.ui,borderTop:`1px solid ${T.border}`,height:56,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 16px",transition:"opacity 0.3s, transform 0.3s",opacity:showUI?1:0,transform:showUI?"translateY(0)":"translateY(100%)",pointerEvents:showUI?"auto":"none"}}>
        <button onClick={prevPage} style={{background:"transparent",border:`1px solid ${T.border}`,borderRadius:8,color:T.text,padding:"8px 18px",cursor:"pointer",fontFamily:"'Cinzel',serif",fontSize:11,letterSpacing:1}}>â Prev</button>
        ...
        <button onClick={nextPage} style={{background:"transparent",border:`1px solid ${T.border}`,borderRadius:8,color:T.text,padding:"8px 18px",cursor:"pointer",fontFamily:"'Cinzel',serif",fontSize:11,letterSpacing:1}}>Next â</button>
      </div>
      ...
      {showUI&&(
        <div style={{position:"absolute",bottom:64,left:"50%",transform:"translateX(-50%)",background:`${T.ui}ee`,border:`1px solid ${C.gold}33`,borderRadius:20,padding:"5px 14px",whiteSpace:"nowrap",pointerEvents:"none",transition:"opacity 0.3s",opacity:showUI?0.8:0}}>
          <span style={{fontFamily:"'Cinzel',serif",fontSize:9,color:C.goldDim,letterSpacing:1}}>â¨ Tap gold words for lore â¢ Select words for dictionary</span>
        </div>
      )}
  ...
  return(
    <div style={{position:"fixed",inset:0,zIndex:600,background:"#0a0905",display:"flex",flexDirection:"column"}}>
      <div style={{flexShrink:0,height:52,background:C.surface,borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",padding:"0 16px",gap:12}}>
        <button onClick={onClose} style={{background:"transparent",border:`1px solid ${C.dim}`,borderRadius:8,color:C.gold,padding:"7px 16px",cursor:"pointer",fontFamily:"'Cinzel',serif",fontSize:13,letterSpacing:1}}>â Back</button>
...
// âââ BOOK DETAIL ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
function BookDetail({ book, onBack, onOpenReader }) {
  ...
  const handleFileSelect=async e=>{
    ...
    setUploading(true); setUploadMsg("Uploading to cloudâ¦");
    ...
    if(ok){
      ...
      setEbookMeta(meta); setUploadMsg("â Uploaded!");
    } else { setUploadMsg("â Upload failed â check Supabase storage policy."); }
  ...
  return(
    <div style={{minHeight:"100%",background:C.bg}}>
      <div style={{position:"sticky",top:0,zIndex:10,background:C.surface,borderBottom:`1px solid ${C.border}`,height:52,display:"flex",alignItems:"center",padding:"0 16px",gap:12}}>
        <button onClick={onBack} style={{background:"transparent",border:`1px solid ${C.dim}`,borderRadius:8,color:C.gold,padding:"7px 16px",cursor:"pointer",fontFamily:"'Cinzel',serif",fontSize:13,letterSpacing:1}}>â Library</button>
      ...
      <div style={{background:`linear-gradient(160deg,${fc}55,${C.card})`,borderBottom:`1px solid ${fc}66`,padding:"28px 20px 24px"}}>
        <div style={{fontFamily:"'Cinzel',serif",fontSize:10,color:C.goldDim,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>{book.series}{book.num>0?` Â· Book ${book.num}`:""}</div>
      ...
      <div style={{padding:"20px 16px",display:"flex",flexDirection:"column",gap:14}}>
        ...
        <div style={{background:C.card,border:`2px solid ${ebookMeta?C.gold:C.border}`,borderRadius:12,overflow:"hidden"}}>
          <div style={{background:ebookMeta?`${C.gold}18`:C.surface,padding:"14px 16px",borderBottom:`1px solid ${ebookMeta?C.gold+"44":C.border}`,display:"flex",alignItems:"center",gap:10}}>
            <span style={{fontSize:20}}>{ebookMeta?"ð":"ð"}</span>
            <div>
            ...
            {ebookMeta?(
              <>
                ...
                <button onClick={handleOpenReader} style={{width:"100%",padding:"16px",borderRadius:10,background:`linear-gradient(135deg,${C.gold},#8a6f28)`,border:"none",color:C.bg,fontFamily:"'Cinzel',serif",fontSize:15,letterSpacing:3,textTransform:"uppercase",fontWeight:700,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:10}}>
                  {progress>0?"ð Continue Reading":"ð Start Reading"}
                </button>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:12}}>
                <div style={{color:C.muted,fontSize:13,lineHeight:1.6}}>Load your personal EPUB or PDF â saved to your private cloud, accessible from any device.</div>
                <div style={{background:"#ffffff06",borderRadius:8,padding:"12px 14px"}}>
                  ...
                  <div style={{color:C.dim,fontSize:12,lineHeight:1.8}}>ð Page-flip or scroll mode<br/>ð¨ Dark / Sepia / Paper themes<br/>ð¤ Font & typography controls<br/>ð Gold keywords â lore info<br/>ð Select words â dictionary</div>
                </div>
                {(uploading||uploadMsg)&&<div style={{color:C.gold,fontFamily:"'Cinzel',serif",fontSize:12,textAlign:"center"}}>{uploadMsg||"Uploadingâ¦"}</div>}
        ...
        <button onClick={()=>setIsRead(r=>!r)} style={{width:"100%",padding:"14px",borderRadius:10,background:isRead?`${C.gold}22`:"transparent",border:`1px solid ${isRead?C.gold:C.dim}`,color:isRead?C.gold:C.muted,fontFamily:"'Cinzel',serif",fontSize:13,letterSpacing:2,textTransform:"uppercase",cursor:"pointer"}}>
          {isRead?"â Marked as Read â tap to undo":"Mark as Read"}
        </button>
      </div>
    </div>
  );
          ...
          :(<div style={{display:"flex",flexDirection:"column",gap:10}}>
            {shelfBooks.map(book=>{
              ...
              return(<div key={book.id} onClick={()=>setDetail(book)} style={{background:`linear-gradient(135deg,${fc2}22,${C.card})`,border:`1px solid ${C.gold}55`,borderLeft:`3px solid ${C.gold}`,borderRadius:8,padding:"14px 16px",cursor:"pointer",display:"flex",alignItems:"center",gap:14}}>
                ...
                <span style={{fontFamily:"'Cinzel',serif",fontSize:10,color:C.gold,letterSpacing:1,flexShrink:0}}>Read â</span>
              </div>);
            })}
          </div>)}
        </div>
        ...
        <>
          <div style={{padding:"12px 16px 0"}}>
            <div style={{position:"relative"}}>
              <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Search titles, authors, seriesâ¦" style={{width:"100%",background:C.surface,border:`1px solid ${C.border}`,borderRadius:10,color:C.text,padding:"12px 40px 12px 44px",fontSize:15,outline:"none"}}/>
              <span style={{position:"absolute",left:14,top:"50%",transform:"translateY(-50%)",color:C.muted,fontSize:18,pointerEvents:"none"}}>ð</span>
              {search&&<button onClick={()=>setSearch("")} style={{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",background:"transparent",border:"none",color:C.muted,cursor:"pointer",fontSize:20,lineHeight:1}}>Ã</button>}
            </div>
          </div>
          <div style={{padding:"8px 16px",display:"flex",gap:8,alignItems:"center"}}>
            <button onClick={()=>setShowFilters(f=>!f)} style={{background:showFilters||isFiltered?`${C.gold}22`:"transparent",border:`1px solid ${showFilters||isFiltered?C.gold:C.dim}`,borderRadius:20,padding:"7px 14px",color:showFilters||isFiltered?C.gold:C.muted,fontFamily:"'Cinzel',serif",fontSize:11,letterSpacing:1,cursor:"pointer"}}>â Filters{isFiltered?" â¢":""}</button>
...
const FACTION_CARDS=[{name:"Space Marines",sub:"Adeptus Astartes",color:"#1e3d6e",icon:"â¬¡"},{name:"Chaos Space Marines",sub:"Heretic Astartes",color:"#6e1a1a",icon:"â§"},{name:"Astra Militarum",sub:"The Imperial Guard",color:"#3a5228",icon:"â¦"},{name:"Necrons",sub:"The Undying Legions",color:"#1a5a3a",icon:"â½"},{name:"Tyranids",sub:"The Great Devourer",color:"#4a1a5a",icon:"â¸"},{name:"Orks",sub:"Waaagh!",color:"#3a4a1a",icon:"â"}];
  ...
  return(<div style={{paddingBottom:80}}>
    <div style={{padding:"44px 20px 36px",textAlign:"center",background:`radial-gradient(ellipse at 50% 0%,${C.red}18,transparent 70%)`,borderBottom:`1px solid ${C.border}`,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{position:"relative",zIndex:1}}>
        <div style={{display:"flex",justifyContent:"center",marginBottom:16,animation:"float 4s ease-in-out infinite"}}><svg width={68} height={68} viewBox="0 0 100 100"><text x="50" y="72" textAnchor="middle" fontSize="70" fill={C.gold} fontFamily="serif">â</text></svg></div>
...
const NAV=[{id:"library",icon:"ð",label:"Library"},{id:"factions",icon:"âï¸",label:"Factions"},{id:"reading",icon:"ð",label:"Reading"},{id:"painting",icon:"ð¨",label:"Painting"},{id:"oracle",icon:"ð¤",label:"Oracle"}];
      ...
      <div style={{display:"flex",flexDirection:"column",height:"100svh",maxWidth:600,margin:"0 auto",background:C.bg}}>
        <div style={{flexShrink:0,height:52,background:C.surface,borderBottom:`1px solid ${C.border}`,display:"flex",alignItems:"center",padding:"0 16px",gap:10,position:"relative"}}>
          ...
          <button onClick={()=>setSection("home")} style={{background:"transparent",border:"none",cursor:"pointer",display:"flex",alignItems:"center",gap:10,padding:0}}>
            <svg width={28} height={28} viewBox="0 0 100 100"><text x="50" y="72" textAnchor="middle" fontSize="70" fill={C.gold} fontFamily="serif">â</text></svg>
        ...
        <div ref={mainRef} style={{flex:1,overflowY:"auto",overscrollBehavior:"contain"}}>
          ...
          {section==="factions"&&<ComingSoon icon="âï¸" title="Factions & Lore"  sub="Deep dives into every faction, Primarch and Chapter."/>}
          {section==="reading" &&<ComingSoon icon="ð" title="Reading Order"    sub="Guided paths through the Black Library."/>}
          {section==="painting"&&<ComingSoon icon="ð¨" title="Painting Sanctum" sub="Colour guides for Citadel, AK Interactive, Vallejo and more."/>}
          {section==="oracle"  &&<ComingSoon icon="ð¤" title="The Oracle"       sub="An AI companion for lore, reading and painting questions."/>}
        </div>
