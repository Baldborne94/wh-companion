export const BOOKS=[
  ...
  {id:3,title:"Galaxy in Flames",series:"Horus Heresy",num:3,author:"Ben Counter",type:"Novel",faction:"Space Marines",era:"Horus Heresy",desc:"The Horus Heresy ignites — the Isstvan III massacre, the first acts of open betrayal, and the galaxy cracked in two. The moment everything changes."},
  ...
  {id:12,title:"A Thousand Sons",series:"Horus Heresy",num:12,author:"Graham McNeill",type:"Novel",faction:"Chaos",era:"Horus Heresy",desc:"Magnus the Red and his psychic legion of the XV are condemned by the Emperor himself — a tragedy of hubris, forbidden knowledge, and the Space Wolves burning Prospero. Read before Prospero Burns."},
  ...
  {id:19,title:"Know No Fear",series:"Horus Heresy",num:19,author:"Dan Abnett",type:"Novel",faction:"Space Marines",era:"Horus Heresy",desc:"The Word Bearers ambush the Ultramarines at Calth without warning — Abnett's real-time battle prose is unlike anything else in the Heresy. One of the series' absolute highlights."},
  ...
  {id:82,title:"First and Only",series:"Gaunt's Ghosts",num:1,author:"Dan Abnett",type:"Novel",faction:"Astra Militarum",era:"41st Millennium",desc:"Colonel-Commissar Gaunt and his regiment of Tanith scouts fight a desperate war across the Sabbat Worlds. The best entry point for anyone who wants 40K from the human soldier's perspective — gritty, brilliant, essential."},
