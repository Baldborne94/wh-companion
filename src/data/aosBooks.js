...
export const AOS_BOOKS = [
  ...
  // ── GOTREK AND FELIX ──────────────────────────────────────────────────────
  { id:"aos89",  title:"Trollslayer",                              author:"William King",     series:"Gotrek and Felix", num:1,  type:"Novel",     isbn:"9781849705097", desc:"The original Gotrek & Felix novel — a doom-seeking Slayer and his reluctant chronicler stumble into every monster and disaster in the Old World. Still hilarious and brutal decades later." },
  { id:"aos90",  title:"Skavenslayer",                             author:"William King",     series:"Gotrek and Felix", num:2,  type:"Novel",     isbn:"9781841541020" },
  { id:"aos91",  title:"Daemonslayer",                             author:"William King",     series:"Gotrek and Felix", num:3,  type:"Novel",     isbn:"9781841541044" },
  { id:"aos92",  title:"Dragonslayer",                             author:"William King",     series:"Gotrek and Felix", num:4,  type:"Novel",     isbn:"9781841541228" },
  { id:"aos93",  title:"Beastslayer",                              author:"William King",     series:"Gotrek and Felix", num:5,  type:"Novel",     isbn:"9781844160525" },
  { id:"aos94",  title:"Vampireslayer",                            author:"William King",     series:"Gotrek and Felix", num:6,  type:"Novel",     isbn:"9781844160532" },
  { id:"aos95",  title:"Giantslayer",                              author:"William King",     series:"Gotrek and Felix", num:7,  type:"Novel",     isbn:"9781844162611" },
  { id:"aos96",  title:"Orcslayer",                                author:"Nathan Long",      series:"Gotrek and Felix", num:8,  type:"Novel",     isbn:"9781844163915" },
  { id:"aos97",  title:"Manslayer",                                author:"Nathan Long",      series:"Gotrek and Felix", num:9,  type:"Novel",     isbn:"9781844165094" },
  { id:"aos98",  title:"Elfslayer",                                author:"Nathan Long",      series:"Gotrek and Felix", num:10, type:"Novel",     isbn:"9781844165759" },
  { id:"aos99",  title:"Shamanslayer",                             author:"Nathan Long",      series:"Gotrek and Felix", num:11, type:"Novel",     isbn:"9781844167739" },
  { id:"aos100", title:"Zombieslayer",                             author:"Nathan Long",      series:"Gotrek and Felix", num:12, type:"Novel",     isbn:"9781844168811" },
  { id:"aos101", title:"Road of Skulls",                           author:"Josh Reynolds",    series:"Gotrek and Felix", num:13, type:"Novel",     isbn:"9781849702928" },
  { id:"aos102", title:"City of the Damned",                       author:"David Guymer",     series:"Gotrek and Felix", num:14, type:"Novel",     isbn:"9781849705295" },
  { id:"aos103", title:"Kinslayer",                                author:"David Guymer",     series:"Gotrek and Felix", num:15, type:"Novel",     isbn:"9781784964511" },
  { id:"aos104", title:"Slayer",                                   author:"David Guymer",     series:"Gotrek and Felix", num:16, type:"Novel",     isbn:"9781784964757" },
  ...
  // ── HAMILCAR ──────────────────────────────────────────────────────────────
  { id:"aos25",  title:"Hamilcar: Champion of the Gods",            author:"David Guymer",                                         series:"Hamilcar",           num:1,  type:"Novel",       isbn:"9781784968298", desc:"The self-aggrandising champion of Sigmar, Hamilcar Bear-Eater, battles through the Mortal Realms with as much bravado as martial skill — one of AoS's most entertaining characters." },
  ...
  { id:"aos66",  title:"Profit's Ruin",                             author:"Josh Reynolds",                                        series:"Drekki Flynt",       num:3,  type:"Novel"       , desc:"Drekki Flynt's sky-pirate crew returns for more aerial combat, aether-gold greed, and treacherous skies in a third Kharadron Overlords adventure."},
  ...
  { id:"aos49",  title:"Bonereapers",                               author:"David Guymer",           series:"", num:0, type:"Novella" , desc:"The implacable Ossiarch Bonereapers harvest souls and bone to feed Nagash's undying armies — David Guymer's novella is cold, relentless, and deeply unsettling."},
  { id:"aos50",  title:"The End of Enlightenment",                  author:"Richard Strachan",       series:"", num:0, type:"Novel" , desc:"As the Ossiarch Bonereapers invade the Realm of Light, a legendary Lumineth Stonemage is charged by Teclis himself to stop one of Nagash's most dangerous generals."},
  ...
  { id:"aos52",  title:"Cursed City",                               author:"C L Werner",             series:"", num:0, type:"Novel" , desc:"A murder mystery in a city ruled by vampires — two investigators uncover a conspiracy that goes deeper than any mortal crime, in a gothic thriller tied to the Cursed City board game."},
  { id:"aos53",  title:"The Hollow King",                           author:"John French",            series:"", num:0, type:"Novel" , desc:"A Soulblight lord investigates strange disappearances in a city of the dead — John French's literary ghost story set in the quiet, eerie corners of Shyish, the Realm of Death."},
  { id:"aos54",  title:"Hallowed Ground",                           author:"Richard Strachan",       series:"", num:0, type:"Novel" , desc:"Witch hunters Galen and Doralia ven Denst pursue a dark secret from their past through the predatory wilds of Ghur — tense monster-hunting with a deeply personal edge."},
  ...
  { id:"aos56",  title:"Starseer's Ruin",                           author:"Adrian Tchaikovsky",     series:"", num:0, type:"Novel"   , desc:"A Seraphon Starseer battles forces threatening to unravel the very fabric of the Mortal Realms — Adrian Tchaikovsky brings his literary sensibility to Age of Sigmar's cosmic scope."},
  ...
  { id:"aos69",  title:"The Red Feast",                             author:"Gav Thorpe",             series:"", num:0, type:"Novel"   , desc:"Set in the Age of Myth before Sigmar's wars began — Gav Thorpe explores the Mortal Realms as they were before Chaos consumed them, through the origins of the Bloodbound cults."},
  { id:"aos70",  title:"Dark Harvest",                              author:"Josh Reynolds",          series:"Warhammer Horror",    num:1, type:"Novel" , desc:"Folk horror in the Mortal Realms — a remote farming village in Ghyran harbours a darkness older than Chaos, perfect for fans of Warhammer Horror's darkest fiction."},
  { id:"aos71",  title:"Gothghul Hollow",                           author:"Anna Stephens",          series:"Warhammer Horror",    num:2, type:"Novel" , desc:"A haunted hollow, dead children, and secrets buried for generations — Anna Stephens's gothic horror tale is one of the darkest and most atmospheric novels Black Library has published."},
  ...
  { id:"aos73",  title:"The Last Volari",                           author:"Gary Kloster",           series:"", num:0, type:"Novel"   , desc:"A noble vampire house struggles to survive in a city increasingly hostile to the undead — Gary Kloster's tale of Soulblight Gravelords navigating mortal politics and their own curse."},
  { id:"aos74",  title:"Kragnos: Avatar of Destruction",            author:"David Guymer",           series:"", num:0, type:"Novel"   , desc:"The god of earthquakes and destruction awakens from aeons of imprisonment — David Guymer chronicles the catastrophic return of a divine force so powerful that even Chaos fears it."},
  { id:"aos75",  title:"Yndrasta: The Celestial Spear",             author:"Noah Van Nguyen",        series:"", num:0, type:"Novel"   , desc:"The Emperor's Huntress, Sigmar's most feared Stormcast Eternal, hunts a monster through the treacherous Realm of Beasts — a character-driven action novel by Noah Van Nguyen."},
  { id:"aos76",  title:"A Dynasty of Monsters",                     author:"Richard Strachan",       series:"", num:0, type:"Novel"   , desc:"The Flesh-eater Courts' delusion explored in full — Richard Strachan's darkest AoS novel follows a court of ghouls who genuinely believe themselves to be noble, honourable knights."},
  { id:"aos77",  title:"Hammers of Sigmar: First Forged",           author:"Richard Strachan",       series:"", num:0, type:"Novel"   , desc:"The origin of the first Stormcast Eternals — what it truly cost to forge warriors from the souls of the dead, and what they lost in becoming something more, and less, than human."},
  { id:"aos78",  title:"Bad Loon Rising",                           author:"Jordan Saia",            series:"", num:0, type:"Novel"   },
  { id:"aos79",  title:"Godsbane",                                  author:"Dale Lucas",             series:"", num:0, type:"Novel"   , desc:"A divine weapon capable of killing gods falls into mortal hands — Dale Lucas delivers a high-stakes quest across the Mortal Realms with world-shaking consequences for the entire Age."},
  { id:"aos105", title:"Lioness of the Parch",                     author:"Evan Dicken",            series:"", num:0, type:"Novel" , desc:"A Lumineth Realm-lord warrior protects the burning Realm of Aqshy from forces that would extinguish its eternal fire — 4th Edition launch fiction by Evan Dicken."},
  { id:"aos106", title:"The Dead Kingdom",                         author:"John French",            series:"", num:0, type:"Novel" , desc:"John French returns to Shyish for a gothic adventure in the Realm of Death as Nagash's power reshapes reality and old kingdoms stir beneath the bone-dust."},
  { id:"aos107", title:"Shade of Khaine",                          author:"Evan Dicken",            series:"", num:0, type:"Novel" , desc:"The shadow of Khaine's murderous influence spreads through the Mortal Realms — Evan Dicken's tale of Daughters of Khaine navigating the boundary between devotion and divine violence."},
  { id:"aos108", title:"Darkoath",                                  author:"Chris Thursten",         series:"", num:0, type:"Novel"   , desc:"The Darkoath barbarians pledge themselves to Chaos in the 4th Edition era — a savage story of blood oaths, betrayal, and survival on the edge of the Mortal Realms."},
  { id:"aos109", title:"Ushoran: Mortarch of Delusion",            author:"Dale Lucas",             series:"", num:0, type:"Novel"   , desc:"The Mortarch of Delusion and his Flesh-eater Courts are explored in depth — the tragedy of history's greatest king, consumed by the madness that defines his existence."},
  ...
  { id:"aos81",  title:"Hammerhal & Other Stories",                 author:"Various",                series:"", num:0, type:"Anthology", isbn:"9781784966973" },
